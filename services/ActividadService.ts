...
const API_URL =
  process.env.NEXT_PUBLIC_API_URL || "http://localhost:3000/ColegioApp/actividad";
...
class ActividadService{
    public async getAll(params:GetActividadesParams = {}): Promise<{ data: IActividad[]; cant: number}> {
        ...
        try {
            ...
            return {cant: 0, data: [{ nombre: "", tipo: "Grupo", descripcion: "", cupo: 0, fecha_fin: "", fecha_inicio:'', estado: "Activa", turno: "TM" }]};
        }
    }
